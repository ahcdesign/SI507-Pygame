...
#create a class from BallDeflector
...
class Game(object):
    side_paddle_buffer = 25 # how far away from the side wall a paddle should start
...
class GameWindow(pyglet.window.Window):
    ...
    def __init__(self, ball_img, paddle_imgs, wall_imgs,
        width = 800, height = 440,*args,**kwargs):
        ...
        # self.score_label = pyglet.text.Label('Base Pong',
        #                 font_name='Times New Roman',
        #                 font_size=14,
        #                 x=width-70, y=height-25,
        ...
        self.fps = 35 #Number of frames per seconds
...
def main():
    ...
    paddle_imgs = [pyglet.resource.image('paddle.png'),
                pyglet.resource.image('paddle1.png')]
